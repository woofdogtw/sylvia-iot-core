...
pub fn post_bulk_invalid_token(context: &mut SpecContext<TestState>) -> Result<(), String> {
    ...
    test_invalid_token(
        ...
        &routes_state,
        Method::POST,
        "/broker/api/v1/device-route/bulk",
    )
}
...
pub fn post_bulk_del_invalid_token(context: &mut SpecContext<TestState>) -> Result<(), String> {
    ...
    test_invalid_token(
        ...
        &routes_state,
        Method::POST,
        "/broker/api/v1/device-route/bulk-delete",
    )
}
...
pub fn post_range_invalid_token(context: &mut SpecContext<TestState>) -> Result<(), String> {
    ...
    test_invalid_token(
        ...
        &routes_state,
        Method::POST,
        "/broker/api/v1/device-route/range",
    )
}
...
pub fn post_range_del_invalid_token(context: &mut SpecContext<TestState>) -> Result<(), String> {
    ...
    test_invalid_token(
        ...
        &routes_state,
        Method::POST,
        "/broker/api/v1/device-route/range-delete",
    )
}
...
pub fn delete(context: &mut SpecContext<TestState>) -> Result<(), String> {
    ...
    let req = server
        .delete("/broker/api/v1/device-route/route1")
        .add_header(
            header::AUTHORIZATION,
...
fn test_post(
    ...
    let body: response::PostDeviceRoute = resp.json();
...
fn test_post_bulk(
    ...
    let req = match use_post {
        ...
        true => server.post("/broker/api/v1/device-route/bulk"),
    };
    let req = req
        .add_header(
            header::AUTHORIZATION,
...
fn test_post_range(
    ...
    let req = match use_post {
        ...
        true => server.post("/broker/api/v1/device-route/range"),
    };
    let req = req
        .add_header(
            header::AUTHORIZATION,
...
fn test_get_count(
    ...
    let body: response::GetDeviceRouteCount = resp.json();
...
fn test_get_list(
    ...
    let resp = runtime.block_on(async { req.await });
    expect(resp.status_code()).to_equal(StatusCode::OK)?;
    let body: response::GetDeviceRouteList = resp.json();
...
fn test_get_list_sort(
    ...
    if let Err(_) = expect(resp.status_code()).to_equal(StatusCode::OK) {
        ...
        return Err(format!(
            "response not 200: /broker/api/v1/device-route/list, {}, {}",
            body.code, message
        ));
    }
    let body: response::GetDeviceRouteList = resp.json();
...
fn test_get_list_format_array(
    ...
    let resp = runtime.block_on(async { req.await });
    expect(resp.status_code()).to_equal(StatusCode::OK)?;
    let body: Vec<response::GetDeviceRouteListData> = resp.json();
