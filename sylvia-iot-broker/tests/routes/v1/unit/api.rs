...
use super::{
    super::{
        super::libs::{
            add_delete_rsc, add_unit_model, create_unit, get_application_model, get_device_model,
            get_device_route_model, get_dldata_buffer_model, get_network_model,
...
pub fn post_invalid_token(context: &mut SpecContext<TestState>) -> Result<(), String> {
    ...
    let req = TestRequest::post().uri("/broker/api/v1/unit");
...
pub fn get_count_invalid_token(context: &mut SpecContext<TestState>) -> Result<(), String> {
    ...
    let req = TestRequest::get().uri("/broker/api/v1/unit/count");
    test_invalid_token(runtime, &routes_state, req)
}
...
pub fn get_list_invalid_token(context: &mut SpecContext<TestState>) -> Result<(), String> {
    ...
    let req = TestRequest::get().uri("/broker/api/v1/unit/list");
    test_invalid_token(runtime, &routes_state, req)
}
...
pub fn get_invalid_token(context: &mut SpecContext<TestState>) -> Result<(), String> {
    ...
    let req = TestRequest::get().uri("/broker/api/v1/unit/id");
    test_invalid_token(runtime, &routes_state, req)
}
...
pub fn patch_not_exist_user(context: &mut SpecContext<TestState>) -> Result<(), String> {
    ...
    let req = TestRequest::patch()
        .uri(format!("/broker/api/v1/unit/manager").as_str())
...
pub fn patch_invalid_token(context: &mut SpecContext<TestState>) -> Result<(), String> {
    ...
    let req = TestRequest::patch().uri("/broker/api/v1/unit/id");
    test_invalid_token(runtime, &routes_state, req)
}
...
pub fn delete(context: &mut SpecContext<TestState>) -> Result<(), String> {
    ...
    let req = TestRequest::delete()
        .uri("/broker/api/v1/unit/manager")
...
pub fn delete_invalid_token(context: &mut SpecContext<TestState>) -> Result<(), String> {
    ...
    let req = TestRequest::delete().uri("/broker/api/v1/unit/id");
    test_invalid_token(runtime, &routes_state, req)
}
...
pub fn delete_user_invalid_token(context: &mut SpecContext<TestState>) -> Result<(), String> {
    ...
    let req = TestRequest::delete().uri("/broker/api/v1/unit/user/id");
    test_invalid_token(runtime, &routes_state, req)
}
...
pub fn delete_user_invalid_perm(context: &mut SpecContext<TestState>) -> Result<(), String> {
    ...
    let req = TestRequest::delete().uri("/broker/api/v1/unit/user/id");
    test_invalid_perm(runtime, &routes_state, TOKEN_OWNER, req)?;

    let req = TestRequest::delete().uri("/broker/api/v1/unit/user/id");
    test_invalid_perm(runtime, &routes_state, TOKEN_MEMBER, req)
}
...
fn test_post(
    ...
    let body: response::PostUnit = runtime.block_on(async { test::read_body_json(resp).await });
...
fn test_get_count(
    ...
    let uri = match param {
        None => "/broker/api/v1/unit/count".to_string(),
        Some(param) => format!(
    ...
    let body: response::GetUnitCount = runtime.block_on(async { test::read_body_json(resp).await });
...
fn test_get_list(
    ...
    let uri = match param {
        None => "/broker/api/v1/unit/list".to_string(),
        Some(param) => format!(
    ...
    let resp = runtime.block_on(async { test::call_service(&mut app, req).await });
    expect(resp.status()).to_equal(StatusCode::OK)?;
    let body: response::GetUnitList = runtime.block_on(async { test::read_body_json(resp).await });
...
fn test_get_list_format_array(
    ...
    let resp = runtime.block_on(async { test::call_service(&mut app, req).await });
    expect(resp.status()).to_equal(StatusCode::OK)?;
    let body: Vec<response::GetUnitListData> =
...
fn test_get(
    ...
    let uri = format!("/broker/api/v1/unit/{}", unit_id);
    let req = TestRequest::get()
        .uri(uri.as_str())
        .insert_header((header::AUTHORIZATION, format!("Bearer {}", token)))
        .to_request();
    let resp = runtime.block_on(async { test::call_service(&mut app, req).await });
    expect(resp.status()).to_equal(StatusCode::OK)?;
    let body: response::GetUnit = runtime.block_on(async { test::read_body_json(resp).await });
...
fn test_patch(
    ...
    let req = TestRequest::patch()
        .uri(format!("/broker/api/v1/unit/{}", unit_id).as_str())
        .insert_header((header::AUTHORIZATION, format!("Bearer {}", token)))
        .set_json(&body)
        .to_request();
    let resp = runtime.block_on(async { test::call_service(&mut app, req).await });
...
fn test_delete_user(
    ...
    let req = TestRequest::delete()
        .uri(format!("/broker/api/v1/unit/user/{}", user_id).as_str())
        .insert_header((header::AUTHORIZATION, format!("Bearer {}", token)))
        .to_request();
    let resp = runtime.block_on(async { test::call_service(&mut app, req).await });
    expect(resp.status()).to_equal(StatusCode::NO_CONTENT)?;
