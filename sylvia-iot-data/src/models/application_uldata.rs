...
pub struct ListQueryCond<'a> {
    ...
    pub proc_lte: Option<DateTime<Utc>>,
    /// To get data greater than and equal to the specified `pub` time.
    pub pub_gte: Option<DateTime<Utc>>,
    /// To get data less than and equal to the specified `pub` time.
    pub pub_lte: Option<DateTime<Utc>>,
...
/// Model operations.
#[async_trait]
pub trait ApplicationUlDataModel: Sync {
